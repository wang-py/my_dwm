...
static const char *fonts[]          = { "monaco:size=12", "fontawesome:size=12", "noto sans sc:size=12" }; //
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_blue, "-sf", col_gray5, NULL };
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button1,        sigdwmblocks,   {.v = 1 } },
	{ ClkStatusText,        0,              Button2,        sigdwmblocks,   {.v = 2 } },
	{ ClkStatusText,        0,              Button3,        sigdwmblocks,   {.v = 3 } },
